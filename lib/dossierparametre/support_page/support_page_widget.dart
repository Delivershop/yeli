...
/// Create a pageCreate a page called "SupportPage" for my app "Yeli
/// Services".
///
/// Purpose: Allow users (clients and providers) to contact support easily.
///
/// Design (in French):
///
/// 1. Section: "Besoin d’aide ?"
///    - Text: "Notre équipe est disponible pour vous aider."
///
/// 2. Button: "Contacter le support via WhatsApp"
///    - Action: Open external link to WhatsApp
///    - Link format:
/// https://wa.me/225000000000?text=Bonjour%20j'ai%20besoin%20d'aide%20sur%20Yeli
///
/// 3. Optional: Add an info card with contact hours: "Disponible du lundi au
/// samedi, de 8h à 20h"
///
/// Style: Friendly, accessible, mobile-first
