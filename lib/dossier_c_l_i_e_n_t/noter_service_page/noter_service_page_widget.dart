...
class NoterServicePageWidget extends StatefulWidget {
  ...
  static String routeName = 'NoterServicePage';
  static String routePath = '/noterServicePage';

  @override
  State<NoterServicePageWidget> createState() => _NoterServicePageWidgetState();
}

class _NoterServicePageWidgetState extends State<NoterServicePageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoterServicePageModel());
